...
- Generated at: `2026-06-07T11:36:28+10:00`
...
- Route command candidates scanned: `771`

## Comparison

| cohort | traces | precision | noise | retrieval_precision | selected | selected_useful | retrieval_selected | retrieval_useful | core_docs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| baseline | 57 | 0.535 | 0.465 | 0.498 | 333 | 178 | 291 | 145 | 42 |
| replay | 57 | 0.355 | 0.645 | 0.351 | 290 | 103 | 259 | 91 | 31 |

- Precision delta: `-0.179`
- Noise delta: `0.179`

## Layered Metrics

- Baseline reason types: `{'safety_guardrail': 42, 'topical_memory': 291}`
- Replay reason types: `{'background_reference': 37, 'bucket_primary': 86, 'mandatory_contract': 3, 'safety_guardrail': 28, 'topical_memory': 136}`
- Replay mandatory contract docs: `3`
- Replay safety guardrail docs: `28`
- Replay core docs selected-but-unused: `19`
- Replay retrieval selected-but-unused: `167`

## Per-Trace Regression Summary

- Compared items: `57`
- Precision regressions: `34`
- Precision improvements: `8`
- Precision ties: `15`
- Precision uncomputed: `0`
- Noise regressions: `34`
...
| add-a-rubric-judge-scoring-policy-to-the-autonomous-impact-eval-runner-so-eval-i | high | 0.833 | 0.500 | -0.333 | Add a rubric judge scoring policy to the autonomous impact eval runner so eval impact r... |
