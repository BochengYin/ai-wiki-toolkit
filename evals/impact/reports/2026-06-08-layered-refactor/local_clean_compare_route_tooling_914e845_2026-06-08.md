...
- Generated at: `2026-06-08T14:03:41+10:00`
- Before: `None`
...
| --- | --- | --- | --- | --- | --- |
| baseline | 58 | 0.531 | 0.469 | 339 | 180 |
| replay | 58 | 0.363 | 0.637 | 284 | 103 |

- Precision delta: `-0.168`
- Noise delta: `0.168`
...
- Selected unknown-created-at docs: `71`
...
| --- | --- | --- | --- | --- | --- |
| promote-draft-ai-wiki-people-bochengyin-index-md | high | 0.167 | - | - | 检查是否已有自动 promote draft 到 ai-wiki/people/bochengyin/index.md 的机制 |
...
| explain-why-historical-local-codex-sessions-are-not-enough-to-safely-infer-sourc | high | 0.333 | - | - | Explain why historical local Codex sessions are not enough to safely infer source incid... |
...
| clarify-whether-an-agent-can-know-current-session-id-and-duration-at-the-moment | high | 0.167 | - | - | Clarify whether an agent can know current session id and duration at the moment it writ... |
...
| ai-wiki-toolkit-trial-and-error-source-incident | high | 0.667 | - | - | 用户询问 ai-wiki-toolkit 被用户下载后，是否可以自动沉淀 trial and error / source incident 经验 |
...
| push-current-changes-to-remote-merge-the-pr-then-release-npm-for-ai-wiki-toolkit | high | 0.333 | - | - | push current changes to remote, merge the PR, then release npm for ai-wiki-toolkit |
