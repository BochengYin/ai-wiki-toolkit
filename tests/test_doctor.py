...
def test_doctor_warns_when_telemetry_paths_are_still_tracked(repo_env: dict[str, Path]) -> None:
    ...
    assert "git rm -r --cached --ignore-unmatch .env.aiwiki ai-wiki/metrics/reuse-events ai-wiki/metrics/route-traces ai-wiki/metrics/task-checks ai-wiki/_toolkit/consolidation ai-wiki/_toolkit/diagnostics ai-wiki/_toolkit/metrics ai-wiki/_toolkit/work ai-wiki/_toolkit/catalog.json" in result.output
